...
function DoctorActiveCaseBox(props) {
    ...
    if(props.seen===false) {
        ...
        seenSectionPClassName="blinkingActive text-center";
        ...
        activitySectionClassName="col-md-1 border-right btn btn-success align-items-center justify-content-center"
        ...
        doaSectionClassName="col-md-2 border-right d-flex align-items-center justify-content-center";
        openSectionClassName="col-md-2 border-right btn btn-success align-items-center justify-content-center";
        activitySectionClassName="col-md-2 btn btn-success align-items-center justify-content-center"
...
export default DoctorActiveCaseBox;